...
ALLOWED_HOSTS = ['web-production-5e1e7.up.railway.app','https://web-production-5e1e7.up.railway.app']
CSRF_TRUSTED_ORIGINS = ['https://web-production-5e1e7.up.railway.app']
